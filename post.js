...
exports.handler = async (event) => {
  try {
    ...
    let prompt_string =
      "create detailed  itinery for " +
      body["Solo/Couple/Family"] +
      "trip for " +
      body["Trip Duration (Number of days)"] +
      " day and " +
      body["Trip Duration (Number of nights)"] +
      " night in " +
      body["Arrival City (Where will your trip begin?)"] +
      "Add must try cusines and must visit popular tourist attractions. I really want to do hiking, food explore.";
